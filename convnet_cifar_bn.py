    ...
    with tf.device("/gpu:0"):
        ...
        with tf.Graph().as_default():
            ...
            with tf.variable_scope("cifar_conv_bn_model"):
                ...
                summary_writer = tf.summary.FileWriter("tf_events/conv_cifar_bn_logs/",
                ...
                for epoch in range(training_epochs):
                    ...
                    if epoch % display_step == 0:
                        ...
                        saver.save(sess, "tf_events/conv_cifar_bn_logs/model-checkpoint", global_step=global_step)
