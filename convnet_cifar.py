    ...
    with tf.device("/gpu:0"):
        ...
        with tf.Graph().as_default():
            ...
            with tf.variable_scope("cifar_conv_model"):
                ...
                # summary_writer = tf.train.SummaryWriter("tf_events/conv_cifar_logs/",
                #                                        graph_def=sess.graph_def)
                summary_writer = tf.summary.FileWriter("tf_events/conv_cifar_logs/", tf.get_default_graph())
                ...
                for epoch in range(training_epochs):
                    ...
                    if epoch % display_step == 0:
                        ...
                        saver.save(sess, "tf_events/conv_cifar_logs/model-checkpoint", global_step=global_step)
